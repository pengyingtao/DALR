...
class AutoCF_gene(BaseModel):
    ...
    def cal_loss(self, batch_data, encoder_adj, decoder_adj):
        ...
        loss = rec_loss + reg_loss + cl_loss + recon_loss + align_loss
        losses = {'rec_loss': rec_loss, 'reg_loss': reg_loss, 'cl_loss': cl_loss, 'recon_loss': recon_loss, 'align_loss': align_loss}
        return loss, losses
